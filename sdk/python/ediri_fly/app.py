...
class AppArgs:
    def __init__(__self__, *,
                 assign_shared_ip_address: pulumi.Input[Optional[_builtins.bool]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a App resource.

        :param pulumi.Input[_builtins.bool] assign_shared_ip_address: Assign a shared ipv4 address to the app. Note that depending on conditions an app may get a shared ip automatically.
        :param pulumi.Input[_builtins.str] name: Name of application
        :param pulumi.Input[_builtins.str] org: The name of the organization to generate the app in, ex: `personal` (your initial org)
        """
    ...
    def assign_shared_ip_address(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def assign_shared_ip_address(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _AppState:
    def __init__(__self__, *,
                 ...
                 shared_ip_address: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: Name of application
        :param pulumi.Input[_builtins.str] org: The name of the organization to generate the app in, ex: `personal` (your initial org)
        :param pulumi.Input[_builtins.str] shared_ip_address: A shared ipv4 address, automatically attached in certain conditions or if explicitly requested
        """
    ...
    def app_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "app_url")

    @app_url.setter
    def app_url(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def shared_ip_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def shared_ip_address(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "shared_ip_address", value)


@pulumi.type_token("fly:index/app:App")
class App(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org: pulumi.Input[Optional[_builtins.str]] = None,
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            shared_ip_address: pulumi.Input[Optional[_builtins.str]] = None) -> 'App':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="appUrl")
    def app_url(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "app_url")

    @_builtins.property
    @pulumi.getter(name="assignSharedIpAddress")
    def assign_shared_ip_address(self) -> pulumi.Output[_builtins.bool]:
        """
        Assign a shared ipv4 address to the app. Note that depending on conditions an app may get a shared ip automatically.
        """
        return pulumi.get(self, "assign_shared_ip_address")
    ...
    @_builtins.property
    @pulumi.getter(name="sharedIpAddress")
    def shared_ip_address(self) -> pulumi.Output[_builtins.str]:
        """
        A shared ipv4 address, automatically attached in certain conditions or if explicitly requested
        """
        return pulumi.get(self, "shared_ip_address")
