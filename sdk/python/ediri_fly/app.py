...
class AppArgs:
    def __init__(__self__, *,
                 assign_shared_ip_address: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 org: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a App resource.
        :param pulumi.Input[builtins.bool] assign_shared_ip_address: Assign a shared ipv4 address to the app. Note that depending on conditions an app may get a shared ip automatically.
        :param pulumi.Input[builtins.str] name: Name of application
        :param pulumi.Input[builtins.str] org: The name of the organization to generate the app in, ex: `personal` (your initial org)
        """
    ...
    def assign_shared_ip_address(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def assign_shared_ip_address(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AppState:
    def __init__(__self__, *,
                 ...
                 shared_ip_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering App resources.
        :param pulumi.Input[builtins.bool] assign_shared_ip_address: Assign a shared ipv4 address to the app. Note that depending on conditions an app may get a shared ip automatically.
        :param pulumi.Input[builtins.str] name: Name of application
        :param pulumi.Input[builtins.str] org: The name of the organization to generate the app in, ex: `personal` (your initial org)
        :param pulumi.Input[builtins.str] shared_ip_address: A shared ipv4 address, automatically attached in certain conditions or if explicitly requested
        """
    ...
    def shared_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class App(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org: Optional[pulumi.Input[builtins.str]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            shared_ip_address: Optional[pulumi.Input[builtins.str]] = None) -> 'App':
        """
    ...
    @property
    @pulumi.getter(name="appUrl")
    def app_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "app_url")

    @property
    @pulumi.getter(name="assignSharedIpAddress")
    def assign_shared_ip_address(self) -> pulumi.Output[builtins.bool]:
        """
        Assign a shared ipv4 address to the app. Note that depending on conditions an app may get a shared ip automatically.
        """
        return pulumi.get(self, "assign_shared_ip_address")
    ...
    @property
    @pulumi.getter(name="sharedIpAddress")
    def shared_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        A shared ipv4 address, automatically attached in certain conditions or if explicitly requested
        """
        return pulumi.get(self, "shared_ip_address")
