...
class GetAppResult:
    ...
    @_builtins.property
    @pulumi.getter
    def appurl(self) -> _builtins.str:
        return pulumi.get(self, "appurl")

    @_builtins.property
    @pulumi.getter
    def currentrelease(self) -> _builtins.str:
    ...
    @_builtins.property
    @pulumi.getter
    def healthchecks(self) -> Sequence[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def ipaddresses(self) -> Sequence[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def sharedipaddress(self) -> _builtins.str:
        """
...
def get_app(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of app
    """
    __args__ = dict()
    __args__['name'] = name
