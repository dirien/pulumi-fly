...
class GetAppResult:
    ...
    @property
    @pulumi.getter
    def appurl(self) -> builtins.str:
        return pulumi.get(self, "appurl")

    @property
    @pulumi.getter
    def currentrelease(self) -> builtins.str:
        return pulumi.get(self, "currentrelease")

    @property
    @pulumi.getter
    def deployed(self) -> builtins.bool:
        return pulumi.get(self, "deployed")

    @property
    @pulumi.getter
    def healthchecks(self) -> Sequence[builtins.str]:
    ...
    @property
    @pulumi.getter
    def ipaddresses(self) -> Sequence[builtins.str]:
    ...
    @property
    @pulumi.getter
    def sharedipaddress(self) -> builtins.str:
        """
...
def get_app(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of app
    """
    __args__ = dict()
    __args__['name'] = name
