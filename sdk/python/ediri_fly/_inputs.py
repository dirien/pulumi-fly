...
class MachineMountArgs:
    def __init__(__self__, *,
                 ...
                 volume: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] path: Path for volume to be mounted on vm, ex: `/data`
        :param pulumi.Input[builtins.str] volume: ID of volume
        """
...
if not MYPY:
    class MachineServiceArgsDict(TypedDict):
        internal_port: pulumi.Input[builtins.int]
        """
...
class MachineServiceArgs:
    def __init__(__self__, *,
                 ...
                 protocol: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] internal_port: Port the machine listens on
        :param pulumi.Input[Sequence[pulumi.Input['MachineServicePortArgs']]] ports: How the port is exposed
        :param pulumi.Input[builtins.str] protocol: `udp` or `tcp`
        """
    ...
    def internal_port(self) -> pulumi.Input[builtins.int]:
        """
        Port the machine listens on
        """
    ...
    def internal_port(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class MachineServicePortArgsDict(TypedDict):
        ...
        """
        force_https: NotRequired[pulumi.Input[builtins.bool]]
        """
        Automatically redirect to HTTPS on "http" handler
        """
        handlers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        start_port: NotRequired[pulumi.Input[builtins.int]]
        """
...
class MachineServicePortArgs:
    def __init__(__self__, *,
                 ...
                 handlers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None,
                 start_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] end_port: For a port range, the last port to listen on
        :param pulumi.Input[builtins.bool] force_https: Automatically redirect to HTTPS on "http" handler
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] handlers: How the edge should process requests; ex empty, or `tls` to attach app's certificate
        :param pulumi.Input[builtins.int] port: Mapped external port number, either `port` or `start_port` and `end_port` must be set.
        :param pulumi.Input[builtins.int] start_port: For a port range, the first port to listen on.
        """
    ...
    @property
    @pulumi.getter
    def handlers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        How the edge should process requests; ex empty, or `tls` to attach app's certificate
        """
    ...
    @handlers.setter
    def handlers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
