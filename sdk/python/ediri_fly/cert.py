...
class _CertState:
    def __init__(__self__, *,
                 ...
                 dns_validation_hostname: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_validation_instructions: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_validation_target: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def dns_validation_hostname(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "dns_validation_hostname")

    @dns_validation_hostname.setter
    def dns_validation_hostname(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "dns_validation_hostname", value)

    @_builtins.property
    @pulumi.getter(name="dnsValidationInstructions")
    def dns_validation_instructions(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "dns_validation_instructions")

    @dns_validation_instructions.setter
    def dns_validation_instructions(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "dns_validation_instructions", value)

    @_builtins.property
    @pulumi.getter(name="dnsValidationTarget")
    def dns_validation_target(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "dns_validation_target")

    @dns_validation_target.setter
    def dns_validation_target(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Cert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dns_validation_instructions: pulumi.Input[Optional[_builtins.str]] = None,
            dns_validation_target: pulumi.Input[Optional[_builtins.str]] = None,
            hostname: pulumi.Input[Optional[_builtins.str]] = None) -> 'Cert':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def check(self) -> pulumi.Output[_builtins.bool]:
        return pulumi.get(self, "check")

    @_builtins.property
    @pulumi.getter(name="dnsValidationHostname")
    def dns_validation_hostname(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "dns_validation_hostname")

    @_builtins.property
    @pulumi.getter(name="dnsValidationInstructions")
    def dns_validation_instructions(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "dns_validation_instructions")

    @_builtins.property
    @pulumi.getter(name="dnsValidationTarget")
    def dns_validation_target(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "dns_validation_target")
