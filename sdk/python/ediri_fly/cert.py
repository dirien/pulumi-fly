...
class _CertState:
    def __init__(__self__, *,
                 ...
                 check: Optional[pulumi.Input[builtins.bool]] = None,
                 dns_validation_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 dns_validation_instructions: Optional[pulumi.Input[builtins.str]] = None,
                 dns_validation_target: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def check(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "check")

    @check.setter
    def check(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "check", value)

    @property
    @pulumi.getter(name="dnsValidationHostname")
    def dns_validation_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dns_validation_hostname")

    @dns_validation_hostname.setter
    def dns_validation_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_validation_hostname", value)

    @property
    @pulumi.getter(name="dnsValidationInstructions")
    def dns_validation_instructions(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dns_validation_instructions")

    @dns_validation_instructions.setter
    def dns_validation_instructions(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_validation_instructions", value)

    @property
    @pulumi.getter(name="dnsValidationTarget")
    def dns_validation_target(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dns_validation_target")

    @dns_validation_target.setter
    def dns_validation_target(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("fly:index/cert:Cert")
class Cert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dns_validation_instructions: Optional[pulumi.Input[builtins.str]] = None,
            dns_validation_target: Optional[pulumi.Input[builtins.str]] = None,
            hostname: Optional[pulumi.Input[builtins.str]] = None) -> 'Cert':
        """
    ...
    @property
    @pulumi.getter
    def check(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "check")

    @property
    @pulumi.getter(name="dnsValidationHostname")
    def dns_validation_hostname(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "dns_validation_hostname")

    @property
    @pulumi.getter(name="dnsValidationInstructions")
    def dns_validation_instructions(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "dns_validation_instructions")

    @property
    @pulumi.getter(name="dnsValidationTarget")
    def dns_validation_target(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "dns_validation_target")
