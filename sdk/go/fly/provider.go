...
func NewProvider(ctx *pulumi.Context,
	...
	if args.FlyApiToken != nil {
		args.FlyApiToken = pulumi.ToSecret(args.FlyApiToken).(pulumi.StringPtrInput)
	}
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:fly/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
