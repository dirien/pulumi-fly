...
namespace ediri.Fly
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ediri.Fly.version.txt");
    ...
    internal sealed class FlyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FlyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
